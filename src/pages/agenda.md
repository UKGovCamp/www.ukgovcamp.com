...
The event is an [Unconference](https://en.wikipedia.org/wiki/Unconference).
After an initial welcome, attendees are invited to come forward with a ‘pitch’
about a topic they want to discuss. A brief show of hands is taken to consider
space and room sizes, and the topic is added to a session grid, which is built
in real time. In this way, attendees set the agenda for the day and can choose
how to spend their time most valuably. There is often a focus on digital and
data topics, but pitches are always wide ranging and engaging.

We strongly encourage movement between sessions, even when they’re running. We
call this the law of mobility and it helps spread ideas between sessions.
...
between, and an hour is put aside for lunch, which is also covered by the event.
Everyone then comes together at the end of the day for summing up, thank yours
and goodbyes. Conversations usually carry on into social time and soft drinks
will be provided at the venue, which is open until 18:00.
...
[Mastodon](https://mastodon.me.uk/@ukgovcamp).
...
There will be a photographer at the event and we encourage you to take
photographs and videos to share publicly, except of anyone who’s wearing a
yellow lanyard. They have requested not to have their likeness shared.

## Prayer room

A prayer room is available. Please ask a volunteer for location and access.

## Quiet room

A quiet room is available; please do not speak or take calls in this room. Ask a
volunteer for location and access.
